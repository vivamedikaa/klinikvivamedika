  ...
  <div class="card-body">
    <div class="card-body">
      <form class="user" action="{{route('pasien.simpan')}}" method="post">
        ...
        <div class="form-group row">
          <div class="col-sm-6 mb-3 mb-sm-0">
            <select class="form-control " name="jenis_asuransi" placeholder="Jenis Asuransi">
              <option value="" selected disabled>Jenis Asuransi</option>
              <option value="RELIANCE">RELIANCE</option>
              <option value="BPJS KESEHATAN">BPJS KESEHATAN</option>
              <option value="ISOMEDIK">ISOMEDIK</option>
        ...
        <div class="form-group">
          <input type="text" class="form-control " name="no_bpjs" placeholder="Nomer Kartu (Tidak Wajib)">
        </div>
        <div class="form-group">
