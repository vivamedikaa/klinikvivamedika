<head>
  ...
  <link rel="stylesheet" href="{{url('/storage/app/public/logo/'. get_setting('gambar'))}}">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{route('dashboard')}}">
        <div class="sidebar-brand-icon {{(get_setting('gambar') !== 1) ? :''}}">
          @if (get_setting('gambar') === 1)
          <img src="{{url('/storage/app/public/logo/'. get_setting('gambar'))}}" width=50px>
          @else
      ...
      <li class="nav-item ">
        ...
        <div id="collapseSix" class="collapse " aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item " href="">Laporan Obat</a>
            <a class="collapse-item " href="">Laporan Pasien</a>
            <a class="collapse-item " href="">Laporan Kunjungan</a>
          </div>
        </div>
      </li>
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                <img width="60px" class="img-profile rounded-circle" src="{{url('/storage/app/public/avatars/'. Auth::user()->avatar)}}">
              </a>
      ...
      <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>Copyright &copy;2021 {{get_setting('n_Klinik')}}</span>
          </div>
        </div>
      </footer>
      <!-- End of Footer -->
